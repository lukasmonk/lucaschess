...
def ld_countries(mapa):
    ...
    for iso, name, border, elo, assoc in ( ("ad", _("Andorra"), ['fr', 'es'], 2252, []),
                                ...
                                ("cn", _("China"), ['ru', 'mn', 'kg', 'af', 'mm', 'la', 'jp', 'vn', 'bt', 'kp', 'tj', 'in', 'np', 'kz', 'ph', 'pk'], 2688, ['tw', 'hk', 'mo']),
                                ...
                                ("fr", _("France"), ['be', 'ch', 'nl', 'ad', 'mc', 'de', 'it', 'lu', 'es'], 2661, ['gp', 'nc', 're', 'pf', 'tf', 'pm', 'wf', 'mf', 'fx', 'yt', 'mq']),
                                ("ga", _("Gabon"), ['cg', 'gq', 'cm', 'st'], 1500, []),
                                ("gb", _("United Kingdom"), ['ie', 'fr'], 2622, ['ck', 'vc', 'gs', 'ag', 'gg', 'im', 'io', 'gi', 'lc', 'tv', 'nf', 'sh', 'pn', 'vg', 'bb', 'bl', 'bm', 'je', 'fk', 'kn', 'tc', 'ai', 'gd', 'ms', 'sb', 'ky']),
                                ...
                                ("ru", _("Russian Federation"), ['cn', 'no', 'ee', 'mn', 'lt', 'us', 'lv', 'ge', 'kp', 'kz', 'fi', 'az', 'ua', 'by', 'pl'], 2740, []),
...
class WorkMap:
    ...
    def restore(self, bin):
        dicW = Util.blob2var(bin)
