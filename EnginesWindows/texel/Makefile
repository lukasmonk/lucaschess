SRC	= bitBoard.cpp book.cpp computerPlayer.cpp enginecontrol.cpp endGameEval.cpp evaluate.cpp \
...
CXX		= g++
FLAGS		= -O3 -Wall -pthread $(INC) -march=corei7 \
...
FLAGS_WIN	= -O3 -Wall -pthread $(INC) -march=corei7 \
		  -DHAS_CTZ -DHAS_POPCNT -DHAS_PREFETCH -DHAS_RT -DNUMA
CXXFLAGS_WIN	= -std=c++11 $(FLAGS_WIN)
CC_WIN		= /home/petero/mingw64/bin/x86_64-w64-mingw32-gcc
...
FLAGS_WINAMD	= -O3 -Wall -pthread $(INC) -march=athlon64-sse3 -mpopcnt \
		  -DHAS_CTZ -DHAS_POPCNT -DHAS_PREFETCH -DHAS_RT -DNUMA
CXXFLAGS_WINAMD	= -std=c++11 $(FLAGS_WINAMD)
CC_WINAMD	= /home/petero/mingw64/bin/x86_64-w64-mingw32-gcc
...
FLAGS_WINOLD	= -O3 -Wall -pthread $(INC) -DHAS_RT -DNUMA
CXXFLAGS_WINOLD	= -std=c++11 $(FLAGS_WINOLD)
CC_WINOLD	= /home/petero/mingw64/bin/x86_64-w64-mingw32-gcc
...
FLAGS_WIN32	= -O3 -Wall -pthread $(INC) -march=athlon64-sse3 -mpopcnt \
                  -DHAS_CTZ -DHAS_POPCNT -DHAS_PREFETCH -DHAS_RT
CXXFLAGS_WIN32	= -std=c++11 $(FLAGS_WIN32)
CC_WIN32	= /home/petero/mingw32/bin/i686-w64-mingw32-gcc
...
FLAGS_WIN32OLD	= -O3 -Wall -pthread $(INC) -DHAS_RT
CXXFLAGS_WIN32OLD = -std=c++11 $(FLAGS_WIN32OLD)
CC_WIN32OLD 	= /home/petero/mingw32/bin/i686-w64-mingw32-gcc
...
CXX_ARM 	= /home/petero/androidgcc/bin/arm-linux-androideabi-g++
FLAGS_ARM	= -O3 -Wall -pthread $(INC) -mthumb -march=armv7-a \
		  -DHAS_CTZ -DHAS_PREFETCH -DHAS_RT
CXXFLAGS_ARM	= -std=c++11 $(FLAGS_ARM)
CC_ARM		= /home/petero/androidgcc/bin/arm-linux-androideabi-gcc
...
depend	: FORCE
	$(CXX_DEF) -MM $(CXXFLAGS_DEF) $(patsubst %.cpp,src/%.cpp,$(SRC)) \
	$(patsubst %.c,src/%.c,$(SRC_GTB)) | \
	sed -e 's!\(.*\):!obj64/\1 objarm/\1 objdef/\1 objw32/\1 objw32old/\1 objw64/\1 objw64amd/\1 objw64old/\1:!' >.depend
...
texel.7z: FORCE $(ALL_EXE) strip
	(VER=$$(echo -e 'uci\nquit' | ./texel64 | grep 'id name' | awk '{print $$4}' | tr -d .) ; \
	 ...
	 7za a texel$${VER}.7z Makefile .depend COPYING readme.txt src/*.?pp src/util/*.?pp \
		...
		src/gtb/compression/lzma/*.[ch] src/syzygy/*.?pp $(ALL_EXE))
