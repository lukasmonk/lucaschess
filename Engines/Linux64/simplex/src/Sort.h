...
//
//
// RUTINAS DE GENERACION PROGRESIVA
//
// ATENCION
// TRUCO: en la generacion se pondra en el peso de la jugada la pieza que se mueve.
// Esto permitira mas tarde optimizar los accesos a board(J.f) como J.peso
// Esto ya no es valido una vez se ha completado el EvaluaPeso de la Jugada ( Obviamente )
//
//
const int UsaAmenazadas = true;
