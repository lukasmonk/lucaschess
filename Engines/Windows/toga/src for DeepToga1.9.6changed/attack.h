...
#define PIECE_CODE(piece)                 (PieceCode[piece])
...
extern bool narrow_piece_attack_king(const board_t * board, int piece, int from, int king);
