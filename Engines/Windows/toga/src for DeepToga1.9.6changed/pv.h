...
extern bool pv_is_ok     (const volatile mv_t pv[]);

extern void pv_copy      (               mv_t dst[], const          mv_t src[]);
extern void pv_copy      (      volatile mv_t dst[], const volatile mv_t src[]);

extern void pv_cat       (               mv_t dst[], const          mv_t src[], int move);
extern void pv_cat       (      volatile mv_t dst[], const          mv_t src[], int move);
