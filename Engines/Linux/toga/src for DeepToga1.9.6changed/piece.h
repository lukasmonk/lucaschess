...
#define KING_MAKE(colour)        (KingMake[colour])
...
#define PIECE_IS_MAJOR(piece)    (PIECE_IS_QUEEN(piece) || PIECE_IS_ROOK(piece))
#define PIECE_IS_MINOR(piece)    (PIECE_IS_KNIGHT(piece) || PIECE_IS_BISHOP(piece))
...
extern const int KingMake[ColourNb];
