...
#ifdef _MSC_VER // WHM addition for debug mode
  #include <crtdbg.h>
  #ifdef _DEBUG
    #define DEBUG TRUE
  #endif
...
extern bool UCI_debug;
extern FILE* fp_debug;

extern volatile int NumberThreads; // UCI
extern volatile int NumberProcessors; // WHM & Vadim Dem
extern volatile int NumberThreadsInternal; // WHM
extern volatile int ThreadsPerDepth;
