...
gaviota-v1.0-linux64 (for 64 bit systems)
gaviota-v1.0-linux32 (for 32 bit systems)
gaviota-1.0-linux64-gcc-static-older-distros (may work for distros with older
libraries, for instance, centOS 6)
